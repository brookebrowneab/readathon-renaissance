...
### Child
- **Fields shown/edited:** name, first_name, last_name, grade_info, class_name, goal_minutes, total_minutes, share_public_link, homeroom_teacher_id, sponsor_id_code
- **Student auth fields (in `student_auth` table):** username, login_enabled, password_hash
