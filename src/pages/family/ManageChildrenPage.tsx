...
// Mock reading logs data (will be connected to DB later)
...
const ManageChildrenPage = () => {
  ...
  const [readingLogs] = useState<Record<string, ReadingLog[]>>(mockReadingLogs);
                  ...
                  >
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="hidden md:flex items-center gap-6 ml-8">
                            <div className="text-center">
                              <p className="text-2xl font-serif text-primary">{child.total_minutes}</p>
                              <p className="text-xs text-muted-foreground">mins read</p>
                            </div>
                            <ReadingGoalRing progress={child.total_minutes} goal={child.goal_minutes} size={60} />
                          </div>
                        </div>
                      ...
                      <div className="flex items-center justify-around mt-4 md:hidden">
                        <div className="text-center">
                          <p className="text-xl font-serif text-primary">{child.total_minutes}</p>
                          <p className="text-xs text-muted-foreground">mins read</p>
                        </div>
                        <ReadingGoalRing progress={child.total_minutes} goal={child.goal_minutes} size={50} />
                      </div>
                    </div>
