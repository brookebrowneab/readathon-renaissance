    ...
    <PublicLayout>
      ...
      <section className="relative overflow-hidden bg-background-warm">
        ...
        <div className="container relative py-16 md:py-24">
          <div className="mx-auto max-w-3xl text-center animate-fade-in space-y-6">
        ...
        <div className="container">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-muted-foreground">
              Students read as much as they can and ask friends, family, and neighbors to support them by pledging:
            </p>
          </div>
          ...
          <p className="text-center mt-8 text-lg font-medium text-brand-blue">
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="space-y-6 text-muted-foreground">
              <p>
                Janney Elementary is one of the largest elementary schools in Washington, DC, yet our per-student district funding is among the lowest in the city. DCPS funds are used primarily to pay teachers. Nearly everything else that makes Janney special is supported by PTA fundraising.
              </p>
              ...
              <div className="rounded-xl bg-card p-6 shadow-md">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Art, music, technology, and Spanish for most grades</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="mt-1.5 h-2 w-2 rounded-full bg-brand-blue shrink-0" />
                    <span>Strong academic and enrichment programs</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="mt-1.5 h-2 w-2 rounded-full bg-brand-blue shrink-0" />
                    <span>A school culture rooted in respect, curiosity, and diligence</span>
                  </li>
                </ul>
              </div>
