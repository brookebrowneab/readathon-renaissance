...
const StudentLoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background-warm to-background-warmer flex items-center justify-center p-4">
      {/* Decorative elements */}
      <div className="fixed top-10 left-10 text-accent-gold opacity-30">
        <Star className="h-12 w-12" />
      </div>
      <div className="fixed top-20 right-16 text-accent-orange opacity-30">
        <Sparkles className="h-10 w-10" />
      </div>
      <div className="fixed bottom-20 left-20 text-accent-gold opacity-30">
        <Sparkles className="h-8 w-8" />
      </div>
      <div className="fixed bottom-16 right-10 text-accent-orange opacity-30">
