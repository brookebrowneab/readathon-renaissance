              ...
              <div className="flex flex-col items-end justify-end gap-0.5">
                {publicNav.map((item) => (
                  <Link
                    ...
                    to={item.href}
                    className={cn(
                      "text-xs font-semibold tracking-widest text-muted-foreground transition-colors hover:text-foreground hover:underline text-right max-w-[180px] lg:max-w-none leading-tight mt-[15px] pt-[8px]",
